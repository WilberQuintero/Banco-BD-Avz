 ...
 * @author Usuario
 */
public class PruebasDeCualquierTipo {
    ...
    public static void main(String[] args) {
        PruebasDeCualquierTipo encrypt = new PruebasDeCualquierTipo();
//        System.out.println(encrypt.getAES("Hola Mundo"));
        System.out.println(encrypt.getAESDecrypt("+m6WVawrK0p6e9e9bCbjuw=="));
    }
}
